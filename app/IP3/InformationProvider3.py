...
# need to include subscriber address in subinfo before sending to correct broker
# for each subscribe or unsubscribe from web UI thread
def SN(subinfo):
    getTicker = subinfo[0]
    if getTicker == 'AAPL':
        return ['IP1']
